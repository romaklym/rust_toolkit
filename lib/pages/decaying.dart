...
class Decaying extends StatefulWidget {
  const Decaying({super.key});

  @override
  State<Decaying> createState() => _DecayingState();
}

class _DecayingState extends State<Decaying> {
  ...
  Future<void> _loadFoundations() async {
    final String response = await rootBundle.loadString('assets/building.json');
